...
""" %(os.path.join(paths.IMAGEDIR,'lcnc_swoop.png'))
    ...
    def init_widgets(self):
        ...
        self.w.filemanager.table.setShowGrid(True)
        self.w.filemanager_usb.table.setShowGrid(True)
        self.w.tooloffsetview.setShowGrid(True)
        self.w.offset_table.setShowGrid(True)
