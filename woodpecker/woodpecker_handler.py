...
class HandlerClass:
    def __init__(self, halcomp, widgets, paths):
        ...
        self.axis_a_list = ["label_axis_a", "label_axis_b", "dro_axis_a", "dro_axis_b",  "action_zero_a", "action_zero_b",  "axistoolbutton_a", "axistoolbutton_b", "action_home_a",
                            "action_home_b", "widget_jog_angular", "widget_increments_angular", "a_plus_jogbutton", "a_minus_jogbutton", "b_plus_jogbutton", "b_minus_jogbutton"]
        self.axis_b_list = ["label_axis_b", "dro_axis_b",  "action_zero_b",  "axistoolbutton_b",
                            "action_home_b", "b_plus_jogbutton", "b_minus_jogbutton"]
        self.button_response_list = ["btn_start", "btn_home_all", "btn_home_x", "btn_home_y",
                            "btn_home_z", "action_home_a", "action_home_b", "btn_reload_file"]
